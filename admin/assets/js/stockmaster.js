 ...
 */
    function load_table() {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $("#stockTableContents").html(data);
                var total_records = $("#stockTableContents tr").length;
    ...
    $("#category").on("change", function(e){
        ...
        $("#subcategory").html("<option value='' selected>Subcategory..</option>");
