                                ...
                                <form action="" method="post" id="userForm">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label for="branchname">Branchn Name</label>
                                            <input class="form-control yearlimit modalyearfrom" type="text" placeholder="Enter Branch Name" id="branchname" name="branchname" required>
                                        </div>
                                        <div class="form-group">
...
<script src="../assets/js/branchmaster.js" type="text/javascript"></script>
</body>
