...
$sql = "Select id,branch_name from tbl_branch where status=1";
$branches = $db->readData($sql);
?>
                                ...
                                <form action="" method="post" id="userForm">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control modalyearstatus" name="branchname" id="branchname">
                    ...
                    <div class="card-body--">    
                        <div class="table-responsive table-container">
                            <table class="table">
                                ...
                                <tbody class="tableContents" id="departmentTableContents">
...
<script src="../assets/js/departmentmaster.js" type="text/javascript"></script>
</body>
