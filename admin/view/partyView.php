                                ...
                                <form action="" method="post" id="userForm">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label for="image">Select Party Image</label>    
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control yearlimit modalyearfrom" type="text" placeholder="Enter Party Name" id="partyname" name="partyname" required>
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="card-body--">    
                        <div class="table-responsive table-container">
                            <table class="table">
                                ...
                                <tbody class="tableContents" id="partiesTableContents">
...
<script src="../assets/js/partiesmaster.js" type="text/javascript"></script>
</body>
