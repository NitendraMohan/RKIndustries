    ...
    try {
        ...
        foreach ($result as $row) {
            $output .= "<tr>
                        ...
                        : "<button class='btn btn-secondary btn-sm btn_toggle' {$permissions['status']} data-id={$row['id']} data-status='deactive' data-dbtable='tbl_bom_product' style='width:70px;'>Deactive</button>") . "</td>
                        <td>
